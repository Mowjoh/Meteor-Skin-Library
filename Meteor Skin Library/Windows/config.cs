...
namespace MeteorSkinLibrary
{
    public partial class config : Form
    {
        ...
        //When a localisation is selected
        ...
        //When a DLC char is checked/unchecked        
        ...
        //When the unlocalised checkbox is ticked
        private void unlocalised_checkbox_changed(object sender, EventArgs e)
        {
            String val = unlocalised_checkbox.Checked ? "1" : "0";
            properties.property_set("unlocalised", val);
        }
        //When you press enter in the workspace textbox
        private void workspace_save(object sender, KeyEventArgs e)
        {
        ...
        //When you press the pick workspace button
        ...
        //When advanced options is checked
